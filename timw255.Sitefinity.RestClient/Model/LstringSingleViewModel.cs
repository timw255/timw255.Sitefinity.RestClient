...
{
    [JsonObject]
    public class LstringSingleViewModel : IComparable, IConvertible, IComparable<string>, IEnumerable<char>, IEnumerable, IEquatable<string>
    {
        ...
        public LstringSingleViewModel(string value)
        {
            this.Value = value;
        ...
        public static bool operator ==(LstringSingleViewModel left, LstringSingleViewModel right)
        {
        ...
        public static implicit operator String(LstringSingleViewModel lstring)
        {
            if (lstring == null)
            {
                return null;
        ...
        public static implicit operator LstringSingleViewModel(string value)
        {
            if (value == null)
            {
                return null;
            }
            return new LstringSingleViewModel(value);
        }
